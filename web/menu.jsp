...
<html>
    ...
    <body style="background-color:rgba(135,206,250)">
        <header>
        ...
        <h2>Gastos</h2>
        <ul class="b">
            <li><a class="link" href="cadastroDespesa.jsp">Lançar novo Gasto</a> </li>
            <li><a class="link" href="consultaDespesa.jsp">Consulta Geral</a></li>
            <li><a class="link" href="consultaDespesaDetalhada.jsp">Consulta por Data</a></li>
        </ul>   
        </div>
        ...
        <h2>Rendas</h2>
        <ul class="b">
            <li><a class="link" href="cadastroReceita.jsp">Lançar nova Renda</a> </li>
            <li><a class="link" href="consultaReceita.jsp">Consulta Geral</a></li>
            <li><a class="link" href="consultaReceitaDetalhada.jsp">Consulta por Data</a></li>
        </ul>
        </div>
        ...
        <h2>Categorias</h2>
        <ul class="b">
            <li><a class="link" href="cadastroCategoria.jsp">Cadastro</a></li>     
            <li><a class="link" href="consultaCategoria.jsp">Consulta</a></li>
        </ul>
        </div>
        ...
        <h2>Usuário</h2>
        <ul class="b">   
            <li><a class="link" href="consultaUsuario.jsp">Consulta Meus Dados</a></li>
        </ul>
        </div>
        ...
        <ul class="b">
            <li><a class="link" href="consultaBalancete.jsp"> Meu Saldo </a></li>
        </ul>
        </div>
         <div class="final">
